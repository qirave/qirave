...
export const variantValues = pgTable('variantValues', {
  ...
  variantId: char('variantId', { length: 13 })
...
export const productVariantRestrictions = pgTable(
...
export type ProductVariantRestriction =
  typeof productVariantRestrictions.$inferSelect;
export type NewProductVariantRestriction =
  typeof productVariantRestrictions.$inferInsert;
