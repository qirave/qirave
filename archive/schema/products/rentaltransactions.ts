import { pgTable, char, boolean, numeric, varchar, timestamp } from 'drizzle-orm/pg-core';
...
export const rentalTransactions = pgTable('rentalTransactions', {
    ...
    rentableProductId: char('rentableProductId', { length: 13 }).references(() => rentableProducts.id), // Reference to the rentable product
