...
export const rentableProducts = pgTable('rentableProducts', {
    id: char("id", { length: 13 }).primaryKey().references(() => products.id), // Reference to products
    ...
    rentalPricePerHour: numeric('rentalPricePerHour', { precision: 10, scale: 2 }), // Optional, can be null
    rentalPricePerDay: numeric('rentalPricePerDay', { precision: 10, scale: 2 }), // Optional, can be null
    rentalPricePerWeek: numeric('rentalPricePerWeek', { precision: 10, scale: 2 }), // Optional, can be null
    rentalPricePerMonth: numeric('rentalPricePerMonth', { precision: 10, scale: 2 }), // Optional, can be null
